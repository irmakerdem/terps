...
export const getAllStrains = () => {
  ...
  let url = `https://terp-backend-develop.onrender.com/api/products?populate[0]=product_terpenes.terpene&populate[1]=product_cannabinoids.cannabinoid&populate[2]=effects.effect`;
